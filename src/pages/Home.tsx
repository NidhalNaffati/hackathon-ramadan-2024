					...
					<div className="container grid max-w-6xl px-4 gap-6 md:grid-cols-2 md:px-6">
						<div className="flex flex-col justify-center space-y-4">
							<div className="space-y-2">
								<h1 className="text-black text-3xl font-bold tracking-tighter sm:text-5xl">
					...
					<div className="flex flex-col items-center space-y-4 text-center">
						...
						<div className="grid max-w-sm gap-4 border border-gray-200 rounded-lg bg-gray-50 p-4 text-sm leading-none divide-y divide-gray-200 dark:border-gray-800 dark:bg-gray-950 dark:divide-gray-800">
							<div className="flex items-center  gap-2">
								...
								<p className="py-2.5  text-black">Choose a story to read</p>
							</div>
							<div className="flex items-center  gap-2">
								<div className="w-4 h-4 rounded-full bg-gray-900" />
								<p className="py-2.5 text-black">
									Start Recording your voice while reading
								</p>
							</div>
							<div className="flex items-center  gap-2">
								<div className="w-4 h-4 rounded-full bg-gray-900" />
								<p className="py-2.5 text-black">Get instance feedback to your spelling</p>
							</div>
							<div className="flex items-center  gap-2">
								<div className="w-4 h-4 rounded-full bg-gray-900" />
							...
							<div className="flex items-center  gap-2">
								<div className="w-4 h-4 rounded-full bg-gray-900" />
								<p className="py-2.5 text-black  dark:text-gray-400">Get your scoore</p>
							</div>
						</div>
					</div>
				</section>
						...
						<div className="space-y-2 flex items-center justify-center flex-col gap-4">
							...
							<div className="grid max-w-sm gap-4 border border-gray-200 rounded-lg bg-gray-50 p-4 text-sm leading-none divide-y divide-gray-200 dark:border-gray-800 dark:bg-gray-950 dark:divide-gray-800">
								<div className="flex items-center gap-4">
									<div className="w-4 h-4 rounded-full bg-gray-900" />
									<p className="py-2.5 text-black">AI-generated stories</p>
								</div>
								<div className="flex items-center gap-4">
									<div className="w-4 h-4 rounded-full bg-gray-900" />
									<p className="py-2.5 text-black">Voice recording</p>
								</div>
								<div className="flex items-center gap-4">
									<div className="w-4 h-4 rounded-full bg-gray-900" />
									<p className="py-2.5 text-black">Progress tracking</p>
								</div>
								<div className="flex items-center gap-4">
									<div className="w-4 h-4 rounded-full bg-gray-900" />
									<p className="py-2.5 text-black">Support a lot of language</p>
								</div>
							</div>
						</div>
					</div>
